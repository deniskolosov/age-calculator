...
var shadow$remote$runtime$api$IRuntime$relay_msg$dyn_14159 = (function (runtime,msg){
...
return shadow$remote$runtime$api$IRuntime$relay_msg$dyn_14159(runtime,msg);
}
});

var shadow$remote$runtime$api$IRuntime$add_extension$dyn_14160 = (function (runtime,key,spec){
var x__5393__auto__ = (((runtime == null))?null:runtime);
...
return shadow$remote$runtime$api$IRuntime$add_extension$dyn_14160(runtime,key,spec);
}
});

var shadow$remote$runtime$api$IRuntime$del_extension$dyn_14168 = (function (runtime,key){
var x__5393__auto__ = (((runtime == null))?null:runtime);
...
return shadow$remote$runtime$api$IRuntime$del_extension$dyn_14168(runtime,key);
}
});
...
var shadow$remote$runtime$api$Inspectable$describe$dyn_14176 = (function (thing,opts){
...
return shadow$remote$runtime$api$Inspectable$describe$dyn_14176(thing,opts);
}
}
});
...
var shadow$remote$runtime$api$IEvalCLJS$_cljs_eval$dyn_14180 = (function (runtime,input,callback){
var x__5393__auto__ = (((runtime == null))?null:runtime);
...
return shadow$remote$runtime$api$IEvalCLJS$_cljs_eval$dyn_14180(runtime,input,callback);
}
});
...
var shadow$remote$runtime$api$IEvalJS$_js_eval$dyn_14185 = (function (runtime,code){
var x__5393__auto__ = (((runtime == null))?null:runtime);
...
return shadow$remote$runtime$api$IEvalJS$_js_eval$dyn_14185(runtime,code);
}
});


shadow.remote.runtime.api.cljs_eval = (function shadow$remote$runtime$api$cljs_eval(runtime,p__14150,callback){
var map__14151 = p__14150;
var map__14151__$1 = cljs.core.__destructure_map(map__14151);
var input = map__14151__$1;
var code = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__14151__$1,new cljs.core.Keyword(null,"code","code",1586293142));
var ns = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__14151__$1,new cljs.core.Keyword(null,"ns","ns",441598760));
