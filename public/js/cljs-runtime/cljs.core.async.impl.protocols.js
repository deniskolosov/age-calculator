...
var cljs$core$async$impl$protocols$ReadPort$take_BANG_$dyn_11475 = (function (port,fn1_handler){
...
return cljs$core$async$impl$protocols$ReadPort$take_BANG_$dyn_11475(port,fn1_handler);
}
});
...
var cljs$core$async$impl$protocols$WritePort$put_BANG_$dyn_11487 = (function (port,val,fn1_handler){
var x__5393__auto__ = (((port == null))?null:port);
...
return cljs$core$async$impl$protocols$WritePort$put_BANG_$dyn_11487(port,val,fn1_handler);
}
});
...
var cljs$core$async$impl$protocols$Channel$close_BANG_$dyn_11498 = (function (chan){
...
return cljs$core$async$impl$protocols$Channel$close_BANG_$dyn_11498(chan);
}
});

var cljs$core$async$impl$protocols$Channel$closed_QMARK_$dyn_11510 = (function (chan){
var x__5393__auto__ = (((chan == null))?null:chan);
...
return cljs$core$async$impl$protocols$Channel$closed_QMARK_$dyn_11510(chan);
}
});
...
var cljs$core$async$impl$protocols$Handler$active_QMARK_$dyn_11512 = (function (h){
...
return cljs$core$async$impl$protocols$Handler$active_QMARK_$dyn_11512(h);
}
});

var cljs$core$async$impl$protocols$Handler$blockable_QMARK_$dyn_11516 = (function (h){
var x__5393__auto__ = (((h == null))?null:h);
...
return cljs$core$async$impl$protocols$Handler$blockable_QMARK_$dyn_11516(h);
}
});

var cljs$core$async$impl$protocols$Handler$commit$dyn_11517 = (function (h){
var x__5393__auto__ = (((h == null))?null:h);
...
return cljs$core$async$impl$protocols$Handler$commit$dyn_11517(h);
}
});
...
var cljs$core$async$impl$protocols$Buffer$full_QMARK_$dyn_11519 = (function (b){
...
return cljs$core$async$impl$protocols$Buffer$full_QMARK_$dyn_11519(b);
}
});

var cljs$core$async$impl$protocols$Buffer$remove_BANG_$dyn_11520 = (function (b){
var x__5393__auto__ = (((b == null))?null:b);
...
return cljs$core$async$impl$protocols$Buffer$remove_BANG_$dyn_11520(b);
}
});

var cljs$core$async$impl$protocols$Buffer$add_BANG__STAR_$dyn_11523 = (function (b,itm){
var x__5393__auto__ = (((b == null))?null:b);
...
return cljs$core$async$impl$protocols$Buffer$add_BANG__STAR_$dyn_11523(b,itm);
}
});

var cljs$core$async$impl$protocols$Buffer$close_buf_BANG_$dyn_11525 = (function (b){
var x__5393__auto__ = (((b == null))?null:b);
...
return cljs$core$async$impl$protocols$Buffer$close_buf_BANG_$dyn_11525(b);
}
});
