...
var cljs$tools$reader$reader_types$Reader$read_char$dyn_11644 = (function (reader){
...
return cljs$tools$reader$reader_types$Reader$read_char$dyn_11644(reader);
}
});

var cljs$tools$reader$reader_types$Reader$peek_char$dyn_11648 = (function (reader){
var x__5393__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$Reader$peek_char$dyn_11648(reader);
}
});
...
var cljs$tools$reader$reader_types$IPushbackReader$unread$dyn_11659 = (function (reader,ch){
var x__5393__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IPushbackReader$unread$dyn_11659(reader,ch);
}
});
...
var cljs$tools$reader$reader_types$IndexingReader$get_line_number$dyn_11664 = (function (reader){
var x__5393__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IndexingReader$get_line_number$dyn_11664(reader);
}
});

var cljs$tools$reader$reader_types$IndexingReader$get_column_number$dyn_11669 = (function (reader){
var x__5393__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IndexingReader$get_column_number$dyn_11669(reader);
}
});

var cljs$tools$reader$reader_types$IndexingReader$get_file_name$dyn_11677 = (function (reader){
var x__5393__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IndexingReader$get_file_name$dyn_11677(reader);
}
});
...
var G__11891 = rdr.cljs$tools$reader$reader_types$Reader$read_char$arity$1(null);
var G__11892 = s.append(c);
c = G__11891;
s = G__11892;
continue;
}
