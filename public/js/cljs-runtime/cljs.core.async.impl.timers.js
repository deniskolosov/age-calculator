...
var i_13882 = (self__.level + (1));
while(true){
if((i_13882 <= (new_level + (1)))){
(update[i_13882] = self__.header);

var G__13885 = (i_13882 + (1));
i_13882 = G__13885;
continue;
} else {
}
...
while(true){
if((i <= self__.level)){
var links_13889 = (update[i]).forward;
if((i < x__$2.forward.length)){
(x__$2.forward[i] = (links_13889[i]));
} else {
x__$2.forward.push((((i < links_13889.length))?(links_13889[i]):null));
}

if((i < links_13889.length)){
(links_13889[i] = x__$2);
} else {
links_13889.push(x__$2);
}
