...
return ((cljs.core.fn_QMARK_(c)) && ((!(((function (){var G__11578 = c;
var G__11578__$1 = (((G__11578 == null))?null:G__11578.prototype);
if((G__11578__$1 == null)){
return null;
} else {
return G__11578__$1.reagentRender;
}
})() == null)))));
});
reagent.impl.component.react_class_QMARK_ = (function reagent$impl$component$react_class_QMARK_(c){
return ((cljs.core.fn_QMARK_(c)) && ((!(((function (){var G__11583 = c;
var G__11583__$1 = (((G__11583 == null))?null:G__11583.prototype);
if((G__11583__$1 == null)){
return null;
} else {
return G__11583__$1.render;
}
})() == null)))));
});
...
var or__5045__auto__ = (function (){var G__11593 = c;
var G__11593__$1 = (((G__11593 == null))?null:G__11593.constructor);
if((G__11593__$1 == null)){
return null;
} else {
return G__11593__$1.displayName;
}
})();
...
var G__11594 = c;
var G__11594__$1 = (((G__11594 == null))?null:G__11594.constructor);
if((G__11594__$1 == null)){
return null;
} else {
return G__11594__$1.name;
}
}
});
...
var _STAR_current_component_STAR__orig_val__11595 = reagent.impl.component._STAR_current_component_STAR_;
var _STAR_current_component_STAR__temp_val__11596 = c;
(reagent.impl.component._STAR_current_component_STAR_ = _STAR_current_component_STAR__temp_val__11596);

try{return reagent.impl.component.wrap_render(c,compiler);
}finally {(reagent.impl.component._STAR_current_component_STAR_ = _STAR_current_component_STAR__orig_val__11595);
}});
...
var c = this;
var G__11623_11687 = reagent.impl.component.goog$module$goog$object.get(c,"cljsRatom");
if((G__11623_11687 == null)){
} else {
reagent.ratom.dispose_BANG_(G__11623_11687);
}
...
var renders_11689 = cljs.core.select_keys(fmap,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"render","render",-1408033454),new cljs.core.Keyword(null,"reagentRender","reagentRender",-358306383)], null));
var render_fun_11690 = cljs.core.first(cljs.core.vals(renders_11689));
...
if((cljs.core.count(renders_11689) > (0))){
} else {
throw (new Error(["Assert failed: ","Missing reagent-render","\n","(pos? (count renders))"].join('')));
}

if(((1) === cljs.core.count(renders_11689))){
} else {
throw (new Error(["Assert failed: ","Too many render functions supplied","\n","(== 1 (count renders))"].join('')));
}

if(cljs.core.ifn_QMARK_(render_fun_11690)){
} else {
throw (new Error(["Assert failed: ",["Expected something callable, not ",cljs.core.pr_str.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([render_fun_11690], 0))].join(''),"\n","(clojure.core/ifn? render-fun)"].join('')));
}
...
var G__11663 = o;
reagent.impl.component.goog$module$goog$object.set(G__11663,cljs.core.name(k),v);
...
var _STAR_current_component_STAR__orig_val__11671 = reagent.impl.component._STAR_current_component_STAR_;
var _STAR_current_component_STAR__temp_val__11672 = c;
(reagent.impl.component._STAR_current_component_STAR_ = _STAR_current_component_STAR__temp_val__11672);

try{return reagent.impl.component.functional_wrap_render(compiler,c);
}finally {(reagent.impl.component._STAR_current_component_STAR_ = _STAR_current_component_STAR__orig_val__11671);
}});
...
var vec__11673 = module$node_modules$react$index.useState((0));
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__11673,(0),null);
var update_count = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__11673,(1),null);
...
var G__11676 = reagent.impl.component.goog$module$goog$object.get(reagent_state,"cljsRatom");
if((G__11676 == null)){
return null;
} else {
return reagent.ratom.dispose_BANG_(G__11676);
}
});
}),[]);
